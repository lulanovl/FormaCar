...
> Последнее обновление: 2026-04-01 (сессия 2)
...
```css
--red: #d42b2b          /* главный акцент */
--red-dark: #a01e1e     /* hover красного */
--red-glow: rgba(212,43,43,0.35)
--black: #080808        /* фон body */
--dark: #0f0f0f         /* секции, sidebar, crm-box */
--card: #141414         /* карточки */
--border: #1f1f1f       /* все рамки */
--white: #f0f0f0
--gray: #666
--silver: #b0b0b0
```
...
**Слоты:** 09:00, 10:00, 11:00, 12:00, 13:00, 14:00, 15:00, 16:00, 17:00, 18:00, 19:00
...
- [ ] **Подтверждение через WhatsApp** — кнопка "Отправить подтверждение" с deeplink на wa.me
